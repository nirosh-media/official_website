...
<head>
<meta charset="utf-8">
<title>Nirosh Media| About</title>
<!-- Stylesheets -->
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Our Story</h2>
						<div class="bold-text">"அறியாமை உன் தவறல்ல தேட தவறியதே உன் தவறு"</div>
						<div class="text">
							<p>nirosh media அலைவரிசை ஆனது வளர்ந்துவரும் இளம் சமுதாயத்திற்காக  என்னால் 2019 ஆண்டு  வைகாசி மாதம் 8 ஆம் திகதி ஆரம்பிக்கப்பட்டது. இன்றய தொழில்நுட்பம் தொடர்பான ஐயப்பாடுகளை எனக்கு தெரிந்த அறிவியலை கொண்டு இலகுவாக எவ்வாறு செய்யலாம் என்பதை எனது காணொளி மூலமாக வெளிப்படுத்துகிறேன். அறிவியலை தெரிந்துகொள்ள எம் மக்களுக்கு மொழி ஒரு தடையாக  இருக்க கூடாது என்பதற்க்காக காணொளிகளை தமிழ் மொழியில் உருவாக்கி வருகிறேன். அறிவியலில் முன்னோக்கி அடிவைக்க எனது  nirosh media அலைவரிசை ஆனது  இளம் சமுதாயத்திற்கு  உதவியாக இருக்கும் என்பதில் மகிழ்ச்சி அடைகிறேன்.</p>
							<div class="g-ytsubscribe" data-channelid="UCyaQdMM1EfFPhw4dUcGlyRg" data-layout="full" data-count="default"></div>
						</div>
					</div>
				</div>
				...
				<div class="image-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="facebook">
							<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FNiroshMediaR&tabs=timeline&width=300&height=377&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=381369639587851" width="300" height="377" scrolling="no" frameborder="" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
						</div>
					</div>
				</div>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="content-column col-xl-9 col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Our Channel Mission</h2>
						<div class="bold-text">அறிவியல் தொழில்நுட்பங்களை இயலாமையாக கொள்ளாமல் தேடுவதற்கான உந்துதலையும் வழிமுறைகளையும் தெரிவித்தது அறிவோடு அறிவியலை கையாளும் இளம் சமுதாயத்தை கட்டியெழுப்புதல்.</div>
						<h3>Our Channel help you for technical knowledge…</h3>
						<div class="row clearfix">
							<div class="column col-lg-6 col-md-6 col-sm-12">
								<ul class="list-style-two">
									<li>-  App Reviews</li>
									<li>-  Websites Reviews</li>
									<li>-  Online Earning</li>
								</ul>
							</div>
							<div class="column col-lg-6 col-md-6 col-sm-12">
								<ul class="list-style-two">
									<li>-  Google Form Design</li>
									<li>-  Tech Videos</li>
